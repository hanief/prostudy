...
@implementation ProjectComparison

@dynamic value;
@dynamic criteria;
@dynamic projects;

static NSString *const kItemsKey = @"projects";
...
- (void)insertProjects:(NSArray *)values atIndexes:(NSIndexSet *)indexes {
    [self willChange:NSKeyValueChangeInsertion valuesAtIndexes:indexes forKey:kItemsKey];
    NSMutableOrderedSet *tmpOrderedSet = [NSMutableOrderedSet orderedSetWithOrderedSet:[self mutableOrderedSetValueForKey:kItemsKey]];
...
- (BOOL)twinComparison{
    return [self firstProject] == [self secondProject];
}
...
- (Project *)secondProject{
    return [self.projects lastObject];
}
